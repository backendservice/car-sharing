...
func (*RegisterCarRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{0}
}
...
func (*RegisterCarReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{1}
}
...
func (*SearchCarsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{2}
}
...
func (*SearchCarsReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{3}
}
...
func (*SearchCarsResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{4}
}
...
func (*UseCarRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{5}
}
...
func (*UseCarReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{6}
}
...
func (*ReturnCarRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{7}
}
...
func (*ReturnCarReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_car_sharing_be88bb2fd627a255, []int{8}
}
...
func init() { proto.RegisterFile("car_sharing.proto", fileDescriptor_car_sharing_be88bb2fd627a255) }

var fileDescriptor_car_sharing_be88bb2fd627a255 = []byte{
	// 472 bytes of a gzipped FileDescriptorProto
	,
}
